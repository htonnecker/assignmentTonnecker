...
public class MainVerticle extends AbstractVerticle {
    ...
    private Completable deployVerticles(JsonObject config) {
        ...
        return vertx.rxDeployVerticle(ApiVerticle.class.getName(), options).toCompletable()
                .andThen(vertx.rxDeployVerticle(ProjectServiceVerticle.class.getName(), options)).toCompletable()
                .andThen(vertx.rxDeployVerticle(FreelancerServiceVerticle.class.getName(), options)).toCompletable();
    }
}
